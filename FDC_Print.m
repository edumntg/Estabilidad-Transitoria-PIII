...
for i = 1:n
     fprintf(' %5g', i), fprintf(' %7.4f', Vu(i)), fprintf(' %8.4f', d(i)), fprintf(' %9.4f', abs(Ploadu(i))), fprintf(' %9.4f', abs(Qloadu(i))), fprintf(' %9.4f', Pgenu(i)), fprintf(' %9.4f ', Qgenu(i)), fprintf(' %9.4f', Pnetau(i)), fprintf(' %9.4f', Qnetau(i)), fprintf(' %8.4f\n', imag(Sshuntu(i)))
end
